...
if iFlag_cython is not None:
    from polycal.algorithms.cython.kernel import calculate_distance_based_on_lon_lat
else:
    from polycal.external.pyearth.gis.gdal.gdal_functions import calculate_distance_based_on_lon_lat
